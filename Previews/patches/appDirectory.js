  ...
  const applicationDataP = {data:applicationP}
   const collections = [{
    ...
    for (let step = 1; step < 11; step++) {
      ...
      instead('fetchAllSubscriptionListingsDataForApplication',findByProps("fetchAllSubscriptionListingsDataForApplication"), () => {return FluxDispatcher.dispatch({
      type: "APPLICATION_SUBSCRIPTIONS_FETCH_LISTINGS_SUCCESS",
      applicationId: applicationG.id,
      groupListing: {
